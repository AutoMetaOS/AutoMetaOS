...
<section
    class="flex-col"
    style="grid-template-rows: {chx ? '1fr' : '5fr 1fr'};"
>
    <div id="appleStyle">
    ...
    <div class="super flex blurW {chx ? 'zen' : ''}">
        <div class="w-50" style="padding:10px">
            <Noise />
        </div>
        {#if !chx}
            <div class="w-50" transition:slide>
                <Tzs />
            </div>
        {/if}
    </div>
    <div class="top flex blurW">
        {#if chx}
            <div class="w-50" in:slide>
                <Pomodoro />
            </div>
            <div class="w-50" in:slide>
                <Tasks />
    ...
    <div class="low flex blurW {chx ? 'zen' : ''}">
        &nbsp;
        {#if !chx}
